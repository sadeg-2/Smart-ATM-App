...
export default function Watchlist() {
  const { currencies, toggleFavorite, getFavorites, fetchCurrencies } = useWatchlistStore();
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-100 to-indigo-200 flex flex-col items-center p-8">
      ...
      <h1 className="text-4xl font-extrabold mb-8 text-gray-800">💱 Currency Watchlist</h1>
